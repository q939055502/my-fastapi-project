...
@router.put("/", summary="更新平台全局设置", dependencies=[require_auth, require_permission("platform:setting:update")])
...
@router.get("/", summary="获取平台全局设置", dependencies=[require_auth, require_permission("platform:setting:read")])
