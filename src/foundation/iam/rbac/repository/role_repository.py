...
class RoleRepository(BaseRepository):
    ...
    def get_by_code(self, code: str, session=None) -> Optional[Role]:
    ...
    def check_role_exists(self, name: str, tenant_id: Optional[int] = None, exclude_id: Optional[int] = None, session=None) -> bool:
