...
from src.foundation.platform.schemas.system_config import SystemConfigUpdate
from src.foundation.platform.service.system_config_service import system_config_service
