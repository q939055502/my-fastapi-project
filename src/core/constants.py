...
class LoginStatusConst:
    ...
    SUCCESS = DictItem(value=True, label="成功", sort=1)
    FAILED = DictItem(value=False, label="失败", sort=2)
...
class ScopeConst:
    ...
    SELF = DictItem(value="self", label="仅本人", sort=1)
...
class SceneConst:
    ...
    APP = DictItem(value="app", label="移动应用", sort=2)
    MERCHANT = DictItem(value="merchant", label="商户", sort=3)
...
class RoleCodeConst:
    ...
    PLATFORM_ADMIN = DictItem(value="platform_admin", label="平台管理", sort=2)
    ...
    TENANT_ADMIN = DictItem(value="tenant_admin", label="租户管理", sort=2)
...
class RegexConst:
    ...
    PASSWORD_STRONG = r"^[a-zA-Z](?=.*[a-z])(?=.*[A-Z])[a-zA-Z0-9!@#$%^&*.]{3,18}$|^[a-zA-Z](?=.*[a-z])(?=.*\d)[a-zA-Z0-9!@#$%^&*.]{3,18}$|^[a-zA-Z](?=.*[a-z])(?=.*[!@#$%^&*.])[a-zA-Z0-9!@#$%^&*.]{3,18}$|^[a-zA-Z](?=.*[A-Z])(?=.*\d)[a-zA-Z0-9!@#$%^&*.]{3,18}$|^[a-zA-Z](?=.*[A-Z])(?=.*[!@#$%^&*.])[a-zA-Z0-9!@#$%^&*.]{3,18}$|^[a-zA-Z](?=.*\d)(?=.*[!@#$%^&*.])[a-zA-Z0-9!@#$%^&*.]{3,18}$"
