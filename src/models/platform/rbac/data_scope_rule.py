...
class DataScopeRule(
    ...
    维度可无限扩展(tenant/org/creator/project/time等)，通过dimension_type灵活定义。
    """
    ...
    role_id = Column(BigInteger, nullable=False, index=True, comment="规则所属角色ID")
    permission_id = Column(BigInteger, nullable=False, index=True, comment="规则对应的具体操作权限ID")
