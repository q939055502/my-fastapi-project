...
router = APIRouter(tags=["平台管理-角色/职位"])


@router.post("/", summary="创建角色/职位")
...
@router.put("/{role_id}", summary="更新角色/职位")
@apply_rate_limit("30/minute")
...
@router.put("/{role_id}/authorized", summary="更新角色/职位权限")
@apply_rate_limit("30/minute")
...
@router.get("/{role_id}", summary="获取角色/职位详情")
@apply_rate_limit("60/minute")
...
@router.get("/{role_id}/authorized", summary="获取角色/职位权限")
@apply_rate_limit("60/minute")
...
@router.delete("/{role_id}", summary="删除角色/职位")
@apply_rate_limit("30/minute")
