...
from src.modules.platform.schemas.system_config import SystemConfigUpdate
from src.modules.platform.service.system_config_service import system_config_service
